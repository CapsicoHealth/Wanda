...
@WebServlet("/svc/ldap/users")
public class GetUsers extends SimpleServlet
  {
    ...
    /*
     * Sample test urls
     * https://localhost:8443/reports/svc/ldap/users?domain=dev.generaldevelopers.com
     */
    public GetUsers()
      {
        super(true);
    ...
    throws Exception
      {
        ...
        List<LdapUser> groups = new LdapUtils().getUsers(C, domain);

        PrintWriter Out = Res.setContentType(ResponseUtil.ContentType.JSON);
        LdapUser.print(groups, Out);
      }
