...
public class ResourceNotAuthorizedException extends SimpleServletException
  {
    private static final long serialVersionUID = -7532753332088264853L;

    public ResourceNotAuthorizedException(String ResourceType, String ResourceId, String ErrorMessage)
      {
    ...
    public ResourceNotAuthorizedException(String ResourceType, String ResourceId)
      {
        super(HttpStatus.Unauthorized, "UnAuthorized resource '"+ResourceType+"': '"+ResourceId+"'.");

        _ResourceType = ResourceType;
        _ResourceId = ResourceId;
      }
    public ResourceNotAuthorizedException(String ResourceType, long ResourceRefnum)
      {
