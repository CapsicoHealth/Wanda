...
public class WandaDefApps
  {
    ...
    private transient final List<String> _masterPathsInternal = Arrays.asList(new String[] { "/svc/Login"
                                                                                           ...
                                                                                           ,"/svc/user/setPswd"
                                                                                           ,"/svc/web/user/invite"
                                                                                           ,"/svc/web/tenants/create"
                                                                                           ,"/svc/web/tenants"
                                                                                           ,"/svc/web/tenants/files"
                                                                                           ,"/svc/web/tenants/files/list"
                                                                                           ,"/svc/web/tenants/startJob"
                                                                                           ,"/svc/web/tenants/jobs"
                                                                                           ,"/svc/web/tenants/jobs/details"
                                                                                           ,"/svc/web/tenants/jobFiles/messages"                                                                                           
                                                                                           ,"/svc/web/users"
                                                                                           ,"/svc/web/user/roles"
                                                                                           ,"/svc/web/user"
                                                                                           ,"/svc/user/account"
                                                                                           ,"/svc/web/user/validation"
                                                                                           ,"/svc/MyTenantList"
                                                                                           ,"/svc/config"
                                                                                           ,"/svc/SelectedTenant"
                                                                                          });
    ...
    throws Exception
      {
        ...
        if (_authPassthroughs == null)
          {
            Wanda.LOG.error("The property 'authPassthroughs' in the Wanda configuration file is defined as 'null'. Must be a valid list of Url path.");
            OK = false;
          }
        else
          {
            for (String path : _authPassthroughsInternal)
              {
                if (_authPassthroughs.contains(path) == false)
                  {
                    Wanda.LOG.error("The property 'authPassthroughs' in the Wanda configuration file must include the path: '" + path + "'");
                    OK = false;
                  }
              }
          }
    ...
    throws Exception
      {
        ...
        if (_masterPaths == null)
          {
            Wanda.LOG.error("The property 'masterPaths' in the Wanda configuration file is defined as 'null'. Must be a valid list of Url path.");
            OK = false;
          }
        else
          {
            for (String path : _masterPathsInternal)
              {
                if (_masterPaths.contains(path) == false)
                  {
                    Wanda.LOG.error("The property 'masterPaths' in the Wanda configuration file must include the path: '" + path + "'");
                    OK = false;
                  }
              }
          }
