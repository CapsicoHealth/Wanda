...
*/
public class UserPlanCreditLedger_Data extends wanda.data._Tilda.TILDA__USERPLANCREDITLEDGER
 {
   protected static final Logger LOG = LogManager.getLogger(UserPlanCreditLedger_Data.class.getName());

   public UserPlanCreditLedger_Data() { }
