...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    * @throws Exception
    */
   public static ListResults<AdminUsersAndTenantsView_Data> filter(Connection C, User_Data U, String searchQuery, String[] roles, long TenantRefnum, String status, int Start, int Size)
   throws Exception
     {
