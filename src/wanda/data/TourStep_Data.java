...
*/
public class TourStep_Data extends wanda.data._Tilda.TILDA__TOURSTEP
 {
   protected static final Logger LOG = LogManager.getLogger(TourStep_Data.class.getName());

   public TourStep_Data() { }
