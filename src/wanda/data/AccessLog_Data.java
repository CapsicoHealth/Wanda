...
*/
public class AccessLog_Data extends wanda.data._Tilda.TILDA__ACCESSLOG
 {
   protected static final Logger LOG = LogManager.getLogger(AccessLog_Data.class.getName());

   public AccessLog_Data() { }
